...
" | - 2.  Settings                                      |
" | -- 2.1  Eye Candy                                   |
" | -- 2.2  Indent and tab behavior                     |
" | -- 2.3  Backup, swap and undo files                 |
...
set noshowmode      " Don't show current mode message.
set signcolumn=yes  " Avoid margin jumping.
set showcmd
" }}}

" 2.2 Indent and tab behavior {{{
set autoindent      " Use indent of previous lines on new lines.
set expandtab       " Use spaces instead of tabs.
set shiftwidth=4    " Indent with four spaces.
set softtabstop=4   " Insert four spaces when pressing <Tab>.
" }}}

" 2.4 Backup, swap and undo files {{{
set nobackup
set nowritebackup
